...
public class ManejadorGlobalExcepciones {
    ...
    public ResponseEntity<ErrorApi> manejarConflicto(IllegalArgumentException exception, HttpServletRequest request) {
        return construirError(HttpStatus.CONFLICT, exception.getMessage(), request.getRequestURI(), null);
    }

    @ExceptionHandler(HttpMessageNotReadableException.class)
    public ResponseEntity<ErrorApi> manejarSolicitudIncorrecta(HttpMessageNotReadableException exception, HttpServletRequest request) {
